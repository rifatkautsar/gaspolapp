...
class DigiTourism extends StatefulWidget {
  @override
  _DigiTourismState createState() => _DigiTourismState();
}

class _DigiTourismState extends State<DigiTourism> {
  @override
