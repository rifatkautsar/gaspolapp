...
class DetailEventHBS extends StatefulWidget {
  @override
  _DetailEventHBSState createState() => _DetailEventHBSState();
}

class _DetailEventHBSState extends State<DetailEventHBS> {
  @override
          ...
          new GestureDetector(
           ...
           child: new Container(
              ...
              decoration: new BoxDecoration(
                ...
                image: new AssetImage("assets/events_medium.jpg"),
                fit: BoxFit.cover,
              )),
              child: Padding(
